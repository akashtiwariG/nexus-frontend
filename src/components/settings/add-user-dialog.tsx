...
//                     Receptionist role can only select one hotel.
//                   </AlertDescription>
//                 </Alert>
//               )}
...
import { useToast } from "@/components/ui/use-toast"
import { Alert, AlertDescription } from "@/components/ui/alert"
import { Info, AlertTriangle, Loader2, Eye, EyeOff } from "lucide-react"
    ...
    await createUser({
      variables: {
        userData: {
          name: fullName,
          email: formData.email.trim(),
          password: formData.password, // Use the password from form instead of hardcoded
          role: formData.role,
          phone: phoneNumber,
          hotelIds: formData.selectedHotels,
        },
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className={`bg-blue-50 pr-10 ${errors.password ? "border-red-500" : ""}`}
                />
                <Button
                  type="button"
                  variant="ghost"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className={`bg-blue-50 pr-10 ${errors.confirmPassword ? "border-red-500" : ""}`}
                />
                <Button
                  type="button"
                  variant="ghost"
